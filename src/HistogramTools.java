...
public class HistogramTools {
	 ...
	 * @throws IOException 
	 */
	public static void plotHistogram(double [] histogram, String nom) throws IOException{
        ...
        JFreeChart jfreechart = ChartFactory.createXYBarChart("Histogramme de l'image", "Niveaux de " + nom, false, "Nombre de pixels", myseriescollection, PlotOrientation.VERTICAL, true, false, false);   
